...
if [ -f ./travis-scripts/is_autogenerated_and_should_skip ]; then
	...
	rm -f ./travis-scripts/is_autogenerated_and_should_skip
	exit 0
fi
...
touch ./travis-scripts/is_autogenerated_and_should_skip
git add ./travis-scripts/is_autogenerated_and_should_skip
