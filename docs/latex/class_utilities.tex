...
\hypertarget{class_utilities_ad7251bf1dd140719a5ff384d81dc4ac0}{\index{Utilities@{Utilities}!verbose\-\_\-log@{verbose\-\_\-log}}
\index{verbose\-\_\-log@{verbose\-\_\-log}!Utilities@{Utilities}}
\subsubsection[{verbose\-\_\-log}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename... Args$>$ static void Utilities\-::verbose\-\_\-log (
\begin{DoxyParamCaption}
\item[{{\bf Args} \&\&...}]{args}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{class_utilities_ad7251bf1dd140719a5ff384d81dc4ac0}


Logs the arguments as cout would to the log file if not null Ends the printed line(s) with a newline then flushes the buffer This function only runs if D\-E\-B\-U\-G\-\_\-\-M\-O\-D\-E and V\-E\-R\-B\-O\-S\-E are defined. 
